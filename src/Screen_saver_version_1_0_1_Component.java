...
public class Screen_saver_version_1_0_1_Component extends JComponent{

    public static final int PREF_WIDTH = 400;
    public static final int PREF_HEIGHT = 400;

    private final Screen_saver_version_1_0_1_Direction direction;
    private int xPos, yPos;
    private String message;
    private Dimension dimension;

    public Screen_saver_version_1_0_1_Component(String message, Font font) {
        dimension=new Dimension(PREF_WIDTH, PREF_HEIGHT);
        setFont(font);
        this.message = message;
        direction = new Screen_saver_version_1_0_1_Direction("right", "down");
    ...
    public Screen_saver_version_1_0_1_Direction getDirection() {
        return direction;
    }
