...
public class Screen_saver_version_1_0_1_Main extends JFrame {
    ...
    private final Screen_saver_version_1_0_1_Component component;
    ...
    private Screen_saver_version_1_0_1_Main(){
        ...
        component=new Screen_saver_version_1_0_1_Component(message, font);
    ...
    private void addComponentListener(){
        addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                Screen_saver_version_1_0_1_Main.this.component.setDimension(Screen_saver_version_1_0_1_Main.this.getWidth(), Screen_saver_version_1_0_1_Main.this.getHeight());
            }
        });
    ...
    private JMenuItem createSetMessageSpeedItem(){
        ...
        speedItem.addActionListener(event -> {
            Screen_saver_version_1_0_1_Vertical_Slider speedSlider=new Screen_saver_version_1_0_1_Vertical_Slider(SLIDER_MIN_VALUE, SLIDER_MAX_VALUE, delay);
    ...
    private JMenuItem createSetMessageItem(){
        ...
        setMessage.addActionListener(actionEvent -> {
            ...
            this.component.setMessage(Screen_saver_version_1_0_1_Main.this.message);
        });
        return setMessage;
    ...
    private JMenuItem createSizeItem() {
        ...
        sizeItem.addActionListener(sizeEvent -> {
            Screen_saver_version_1_0_1_Vertical_Slider sizeSlider = new Screen_saver_version_1_0_1_Vertical_Slider(SLIDER_MIN_VALUE, SLIDER_MAX_VALUE, fontSize);
    ...
    private static void createAndShowGUI(){
        ...
        JFrame frame=new Screen_saver_version_1_0_1_Main();
